...
-(void)showData:(MusicModel *)musicModel{
    ...
    self.musicDownloadPercent.text =  [NSString stringWithFormat:@"%.3f",musicModel.progress];
    ...
    self.musicModel.task.downloadProgressBlock = ^(CGFloat progress, CGFloat totalRead, CGFloat totalExpectedToRead){
        ...
        weakSelf.musicDownloadPercent.text = [NSString stringWithFormat:@"%f%%",progress*100];
    };
